...
enum enum_ssi_type { ssi_type__NULL = -1, ssi_type_arg_ssi = 0, ssi_type_arg_essa };
...
struct gengetopt_args_info
{
  ...
  int rand_seed_arg;	/**< @brief Random seed for obfuscation.  */
  char * rand_seed_orig;	/**< @brief Random seed for obfuscation original value given at command line.  */
  const char *rand_seed_help; /**< @brief Random seed for obfuscation help description.  */
  ...
  char ** include_filter_arg;	/**< @brief Only include the files matching the regular expression.  */
  char ** include_filter_orig;	/**< @brief Only include the files matching the regular expression original value given at command line.  */
  unsigned int include_filter_min; /**< @brief Only include the files matching the regular expression's minimum occurreces */
  unsigned int include_filter_max; /**< @brief Only include the files matching the regular expression's maximum occurreces */
  const char *include_filter_help; /**< @brief Only include the files matching the regular expression help description.  */
  char ** include_filter_out_arg;	/**< @brief Do not include the files matching the regular expression.  */
  char ** include_filter_out_orig;	/**< @brief Do not include the files matching the regular expression original value given at command line.  */
  unsigned int include_filter_out_min; /**< @brief Do not include the files matching the regular expression's minimum occurreces */
  unsigned int include_filter_out_max; /**< @brief Do not include the files matching the regular expression's maximum occurreces */
  const char *include_filter_out_help; /**< @brief Do not include the files matching the regular expression help description.  */
  ...
  unsigned int include_filter_given ;	/**< @brief Whether include-filter was given.  */
  unsigned int include_filter_out_given ;	/**< @brief Whether include-filter-out was given.  */
