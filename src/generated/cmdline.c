...
const char *gengetopt_args_info_full_help[] = {
  ...
  "      --rand-seed=INT           Random seed for obfuscation",
  ...
  "      --include-filter=STRING   Only include the files matching the regular \n                                  expression",
  "      --include-filter-out=STRING\n                                Do not include the files matching the regular \n                                  expression",
...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[36] = gengetopt_args_info_full_help[39];
  gengetopt_args_info_help[37] = gengetopt_args_info_full_help[40];
  gengetopt_args_info_help[38] = gengetopt_args_info_full_help[43];
  gengetopt_args_info_help[39] = gengetopt_args_info_full_help[54];
  gengetopt_args_info_help[40] = gengetopt_args_info_full_help[55];
  gengetopt_args_info_help[41] = gengetopt_args_info_full_help[56];
  gengetopt_args_info_help[42] = gengetopt_args_info_full_help[57];
  gengetopt_args_info_help[43] = gengetopt_args_info_full_help[66];
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->include_filter_given = 0 ;
  args_info->include_filter_out_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->include_filter_arg = NULL;
  args_info->include_filter_orig = NULL;
  args_info->include_filter_out_arg = NULL;
  args_info->include_filter_out_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->rand_seed_help = gengetopt_args_info_full_help[8] ;
  args_info->run_help = gengetopt_args_info_full_help[9] ;
  args_info->run_min = 0;
  args_info->run_max = 0;
  args_info->r_option_help = gengetopt_args_info_full_help[10] ;
  args_info->r_option_min = 0;
  args_info->r_option_max = 0;
  args_info->define_help = gengetopt_args_info_full_help[11] ;
  args_info->define_min = 0;
  args_info->define_max = 0;
  args_info->no_warnings_help = gengetopt_args_info_full_help[12] ;
  args_info->read_xml_help = gengetopt_args_info_full_help[14] ;
  args_info->no_xml_validation_help = gengetopt_args_info_full_help[15] ;
  args_info->include_help = gengetopt_args_info_full_help[16] ;
  args_info->include_harder_help = gengetopt_args_info_full_help[17] ;
  args_info->include_regexp_help = gengetopt_args_info_full_help[18] ;
  args_info->include_filter_help = gengetopt_args_info_full_help[19] ;
  args_info->include_filter_min = 0;
  args_info->include_filter_max = 0;
  args_info->include_filter_out_help = gengetopt_args_info_full_help[20] ;
  args_info->include_filter_out_min = 0;
  args_info->include_filter_out_max = 0;
  args_info->include_name_help = gengetopt_args_info_full_help[21] ;
  args_info->include_searchdir_help = gengetopt_args_info_full_help[22] ;
  args_info->c_option_help = gengetopt_args_info_full_help[24] ;
  args_info->c_option_min = 0;
  args_info->c_option_max = 0;
  args_info->generate_c_help = gengetopt_args_info_full_help[25] ;
  args_info->extension_help = gengetopt_args_info_full_help[26] ;
  args_info->web_app_help = gengetopt_args_info_full_help[27] ;
  args_info->with_php_help = gengetopt_args_info_full_help[28] ;
  args_info->optimize_help = gengetopt_args_info_full_help[29] ;
  args_info->output_help = gengetopt_args_info_full_help[30] ;
  args_info->execute_help = gengetopt_args_info_full_help[31] ;
  args_info->next_line_curlies_help = gengetopt_args_info_full_help[33] ;
  args_info->no_leading_tab_help = gengetopt_args_info_full_help[34] ;
  args_info->tab_help = gengetopt_args_info_full_help[35] ;
  args_info->no_hash_bang_help = gengetopt_args_info_full_help[36] ;
  args_info->dump_help = gengetopt_args_info_full_help[38] ;
  args_info->dump_min = 0;
  args_info->dump_max = 0;
  args_info->dump_xml_help = gengetopt_args_info_full_help[39] ;
  args_info->dump_xml_min = 0;
  args_info->dump_xml_max = 0;
  args_info->dump_dot_help = gengetopt_args_info_full_help[40] ;
  args_info->dump_dot_min = 0;
  args_info->dump_dot_max = 0;
  args_info->dump_parse_tree_help = gengetopt_args_info_full_help[41] ;
  args_info->dump_tokens_help = gengetopt_args_info_full_help[42] ;
  args_info->list_passes_help = gengetopt_args_info_full_help[43] ;
  args_info->convert_uppered_help = gengetopt_args_info_full_help[45] ;
  args_info->no_dot_line_numbers_help = gengetopt_args_info_full_help[47] ;
  args_info->no_dot_nulls_help = gengetopt_args_info_full_help[48] ;
  args_info->no_dot_empty_lists_help = gengetopt_args_info_full_help[49] ;
  args_info->no_xml_line_numbers_help = gengetopt_args_info_full_help[51] ;
  args_info->no_xml_base_64_help = gengetopt_args_info_full_help[52] ;
  args_info->no_xml_attrs_help = gengetopt_args_info_full_help[53] ;
  args_info->flow_insensitive_help = gengetopt_args_info_full_help[55] ;
  args_info->call_string_length_help = gengetopt_args_info_full_help[56] ;
  args_info->ssi_type_help = gengetopt_args_info_full_help[57] ;
  args_info->stats_help = gengetopt_args_info_full_help[59] ;
  args_info->rt_stats_help = gengetopt_args_info_full_help[60] ;
  args_info->cfg_dump_help = gengetopt_args_info_full_help[61] ;
  args_info->cfg_dump_min = 0;
  args_info->cfg_dump_max = 0;
  args_info->debug_help = gengetopt_args_info_full_help[62] ;
  args_info->debug_min = 0;
  args_info->debug_max = 0;
  args_info->dont_fail_help = gengetopt_args_info_full_help[63] ;
  args_info->disable_help = gengetopt_args_info_full_help[64] ;
  args_info->disable_min = 0;
  args_info->disable_max = 0;
  args_info->pause_help = gengetopt_args_info_full_help[65] ;
...
{
  unsigned int i;
  free_string_field (&(args_info->rand_seed_orig));
  ...
  free_multiple_string_field (args_info->include_filter_given, &(args_info->include_filter_arg), &(args_info->include_filter_orig));
  free_multiple_string_field (args_info->include_filter_out_given, &(args_info->include_filter_out_arg), &(args_info->include_filter_out_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->rand_seed_given)
    write_into_file(outfile, "rand-seed", args_info->rand_seed_orig, 0);
  ...
  write_multiple_into_file(outfile, args_info->include_filter_given, "include-filter", args_info->include_filter_orig, 0);
  write_multiple_into_file(outfile, args_info->include_filter_out_given, "include-filter-out", args_info->include_filter_out_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->include_filter_given, args_info->include_filter_min, args_info->include_filter_max, "'--include-filter'"))
     error = 1;
  
  if (check_multiple_option_occurrences(prog_name, args_info->include_filter_out_given, args_info->include_filter_out_min, args_info->include_filter_out_max, "'--include-filter-out'"))
     error = 1;
  ...
  if (args_info->include_filter_given && ! args_info->include_given)
    {
      fprintf (stderr, "%s: '--include-filter' option depends on option 'include'%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
  if (args_info->include_filter_out_given && ! args_info->include_given)
    {
      fprintf (stderr, "%s: '--include-filter-out' option depends on option 'include'%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * include_filter_list = NULL;
  struct generic_list * include_filter_out_list = NULL;
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "include-filter",	1, NULL, 0 },
        { "include-filter-out",	1, NULL, 0 },
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "rand-seed") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->rand_seed_arg), 
                 &(args_info->rand_seed_orig), &(args_info->rand_seed_given),
                &(local_args_info.rand_seed_given), optarg, 0, 0, ARG_INT,
                check_ambiguity, override, 0, 0,
                "rand-seed", '-',
                additional_error))
              goto failure;
          ...
          /* Only include the files matching the regular expression.  */
          else if (strcmp (long_options[option_index].name, "include-filter") == 0)
          {
          
            if (update_multiple_arg_temp(&include_filter_list, 
                &(local_args_info.include_filter_given), optarg, 0, 0, ARG_STRING,
                "include-filter", '-',
                additional_error))
              goto failure;
          
          }
          /* Do not include the files matching the regular expression.  */
          else if (strcmp (long_options[option_index].name, "include-filter-out") == 0)
          {
          
            if (update_multiple_arg_temp(&include_filter_out_list, 
                &(local_args_info.include_filter_out_given), optarg, 0, 0, ARG_STRING,
                "include-filter-out", '-',
                additional_error))
              goto failure;
  ...
  update_multiple_arg((void *)&(args_info->include_filter_arg),
    &(args_info->include_filter_orig), args_info->include_filter_given,
    local_args_info.include_filter_given, 0,
    ARG_STRING, include_filter_list);
  update_multiple_arg((void *)&(args_info->include_filter_out_arg),
    &(args_info->include_filter_out_orig), args_info->include_filter_out_given,
    local_args_info.include_filter_out_given, 0,
    ARG_STRING, include_filter_out_list);
  ...
  local_args_info.define_given = 0;
  args_info->include_filter_given += local_args_info.include_filter_given;
  local_args_info.include_filter_given = 0;
  args_info->include_filter_out_given += local_args_info.include_filter_out_given;
  local_args_info.include_filter_out_given = 0;
...
failure:
  ...
  free_list (include_filter_list, 1 );
  free_list (include_filter_out_list, 1 );
